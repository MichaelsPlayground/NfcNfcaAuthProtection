    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mRead.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(RemoveWriteProtectionActivity.this, NtagDataReadingActivity.class);
                startActivity(i);
                return false;
            }
        });
        ...
        mWrite.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(RemoveWriteProtectionActivity.this, WriteActivity.class);
                startActivity(i);
                return false;
            }
        });
        ...
        mWriteProtection.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(RemoveWriteProtectionActivity.this, SetWriteProtectionActivity.class);
                startActivity(i);
                return false;
            }
        });
        ...
        mRemoveProtection.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(RemoveWriteProtectionActivity.this, RemoveWriteProtectionActivity.class);
                startActivity(i);
                return false;
            }
        });
        ...
        mSpecialSettings.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(RemoveWriteProtectionActivity.this, SpecialSettingsActivity.class);
                startActivity(i);
                return false;
            }
        });
        ...
        mWriteNdef.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(RemoveWriteProtectionActivity.this, WriteNdefMessageActivity.class);
                startActivity(i);
                return false;
            }
        });
        ...
        mEnableMirrorNdefMessage.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(RemoveWriteProtectionActivity.this, EnableMirrorForNdefActivity.class);
                startActivity(i);
                return false;
            }
        });
        ...
        mClearTag.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(RemoveWriteProtectionActivity.this, ClearTagActivity.class);
                startActivity(i);
                return false;
            }
        });
